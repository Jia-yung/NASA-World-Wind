    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <figure class="event-card shadow-lg">
                ...
                <a href="https://www.freetreesociety.org/index.php/whats-on/#giveaways"></a>
            </figure>
            </div>
            <div class="col-sm-4">
                <figure class="event-card shadow-lg">
                    ...
                    <a href="https://freetreesociety.org/index.php/explore-visit/"></a>
                </figure>
            </div>
            <div class="col-sm-4">
                <figure class="event-card shadow-lg">
                    ...
                    <a href="https://freetreesociety.org/index.php/climate-reality/"></a>
                </figure>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <figure class="event-card shadow-lg">
                ...
                <figcaption>
                    <div class="date"><span class="day">28</span><span class="month">Oct</span></div>
                    <h3>Nursery maintenance</h3>
                    <p>
                    Forest seedlings are collected by MNS members, the public or even bought from Orang Asli. The seeds will include forest trees, fruit trees and mangrove plants. Gardening is a weekly activity or by request from school groups or companies on weekdays. Volunteers learn about the science of seeds and planting techniques: weeding, sprouting, sowing, watering, transferring, change of poly bags, conditioning for replanting, and planting at site.
                    </p>
                </figcaption>
                <a href="https://ucfnetworkbukitpersekutuan.wordpress.com/ucf-activities/"></a>
            </figure>
            </div>
            <div class="col-sm-4">
                <figure class="event-card shadow-lg">
            ...
            <div class="col-sm-4">
                <figure class="event-card shadow-lg">
                    ...
                    <figcaption style="padding: 25px 20px 90px">
                        <div class="date"><span class="day">01</span><span class="month">Dec</span></div>
                        <h3>Tree enrichment planting </h3>
                        <p>
                        Tree enrichment planting improves the canopy layers of the forest providing different layers for different wildlife. The UCF has four main forested area that can take years of replanting and growth to reinstate the natural forest.
                        </p>
                    </figcaption>
                    <a href="https://ucfnetworkbukitpersekutuan.wordpress.com/supporting-ucf/"></a>
                </figure>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <figure class="event-card shadow-lg">
                ...
                <a href="https://www.mns.my/volunteer/"></a>
            </figure>
            </div>
            <div class="col-sm-4">
                <figure class="event-card shadow-lg">
                    ...
                    <a href="https://www.mns.my/donate/"></a>
                </figure>
            </div>
            <div class="col-sm-4">
            <figure class="event-card shadow-lg">
                ...
                <figcaption>
                    ...
                    <h3>TNB Night Run </h3>
                    <p>
                    TNB Run is a eco-run which to raise awareness to the public of conserving energy at the same time promote a healthy lifestyle.
                    </p>
                </figcaption>
                <a href="https://www.justonlineregistration.com/blog/events/tnb-energy-night-run/"></a>
            </figure>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <figure class="event-card shadow-lg">
                ...
                <figcaption>
                    <div class="date"><span class="day">28</span><span class="month">Oct</span></div>
                    <h3>Protecting The Natural World</h3>
                    <p>
                    There's much more to discover about the issues you care about. Find out how organisations are taking positive action to change our future.
                    </p>
                </figcaption>
                <a href="https://www.unilever.com/about/take-action/topics/protecting-the-natural-world.html"></a>
            </figure>
            </div>
            <div class="col-sm-4">
                <figure class="event-card shadow-lg">
                    ...
                    <a href="https://www.unilever.com/sustainable-living/reducing-environmental-impact/greenhouse-gases/protecting-our-forests/"></a>
                </figure>
            </div>
            <div class="col-sm-4">
                <figure class="event-card shadow-lg">
                    ...
                    <a href="https://www.unilever.com/sgreenustainable-living/reducing-environmental-impact/greenhouse-gases/climate-friendly-freezers/"></a>
                </figure>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <figure class="event-card shadow-lg">
                    ...
                    <a href="http://www.landskapmalaysia.org/our-programmes/hutan-kita/"></a>
                </figure>
            </div>
        </div>
        <br/>
